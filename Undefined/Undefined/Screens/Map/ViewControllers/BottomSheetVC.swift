...
class BottomSheetVC: UIViewController {
    ...
    var partialView: CGFloat {
        ...
        let partial = (left.frame.maxY + UIApplication.shared.statusBarFrame.height)
        
        return UIScreen.main.bounds.height - partial
    }
    
    override func viewDidLoad() {
        super.viewDidLoad()
        let gesture = UIPanGestureRecognizer.init(target: self,
                                                  action: #selector(BottomSheetVC.panGesture))
    ...
    func roundViews() {
        ...
        left.layer.borderColor = UIColor(red: 0,
                                         green: 148/255,
                                         blue: 247.0/255.0,
                                         alpha: 1).cgColor
